...
class MainActivity : AppCompatActivity() {
    ...
    private fun ExpenseListAdapter(): ExpenseListAdapter {
    ...
    private fun CategoryListAdapter(): CategoryListAdapter {
        return CategoryListAdapter()

    }

    private fun CategoryUiData(name: String, isSelected: Boolean): CategoryUiData {
        return CategoryUiData(name, isSelected)
